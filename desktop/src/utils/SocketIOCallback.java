...
public class SocketIOCallback implements IOCallback {
        ...
        case "message":
            if (newListListener != null) {
                try {
                    ...
                    Contacts contact = cd.performDBfind(connectionSource, o.getString("sender"));
                    m.setContact(contact);
                    m.setMe(false);
                    m.setMessage(o.getString("content"));
                    mess.performDBInsert(connectionSource, m);
	...
	public static void setConnectionSource(ConnectionSource connectionSource) {
		SocketIOCallback.connectionSource = connectionSource;
	}
