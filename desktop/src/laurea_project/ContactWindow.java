            ...
            public void run() {
                try {
                    ...
                    connectionSource = new JdbcConnectionSource(
                            "jdbc:sqlite:data.db");
                    connectionSourceCheck = new JdbcConnectionSource(
                            "jdbc:sqlite:check");
                    setupDataBases();
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getClickCount() == 2) {
                        ...
                        if (selectedItem != null) {
                            ...
                            ChatWindow chat = new ChatWindow(frame,
                                    selectedItem, messageDao, checkDao, socket);
